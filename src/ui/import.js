    ...
    return function(selection) {
        ...
        if (importSupport) {
            ...
            message.append('p')
                ...
                .append('small')
                .text('GeoJSON, TopoJSON, KML, CSV, GPX, Zipped Shapefile, and OSM XML supported. You can also drag & drop files.');
            ...
            wrap.append('p')
                ...
                .text('Sorry, geojson.io supports importing GeoJSON, TopoJSON, KML, CSV, GPX, Zipped Shapefile, and OSM XML files, but ' +
